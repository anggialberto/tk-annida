  ...
  return (
    <>
      ...
      <Menu theme="light" mode="inline">
        ...
        <Menu.Item key="3">
          <NavLink to="/registration-student">
            <span
              className="icon"
              style={{
                background: page === "registration-student" ? color : "",
              }}
            >
              {registrationStudent}
            </span>
            <span className="label">Registration Student</span>
          </NavLink>
        </Menu.Item>
        ...
        <Menu.Item key="3">
          <NavLink to="/school-year">
            <span
              className="icon"
              style={{
                background: page === "school-year" ? color : "",
              }}
            >
              {schoolYear}
            </span>
